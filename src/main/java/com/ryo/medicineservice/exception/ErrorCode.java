...
public enum ErrorCode {
    ...
    HTTP_MESSAGE_NOT_READABLE(1009, "HTTP_MESSAGE_NOT_READABLE", HttpStatus.BAD_REQUEST),
    HTTP_METHOD_NOT_SUPPORTED(1010, "HTTP_METHOD_NOT_SUPPORTED", HttpStatus.BAD_REQUEST),
